...
public class VendasM extends VeiculoM {
    ...
    public VendasM(String chassi, String marca, String versao, int ano, String modelo, String cor, float preco, Date dataVenda, boolean codicao, float kmAtual, int id_vendas, Date data_venda, String cpf, String chassi1, float valor_final) {
